...
export const metadata: Metadata = {
  title: "Blue Barber - Best Haircuts in Town",
  description: "Visit Blue Barber for professional haircuts and grooming services.",
  keywords: "barber, haircuts, grooming, professional barbers",
  metadataBase: new URL("https://bluebarber.com"),
  alternates: { canonical: "https://bluebarber.com" },
  openGraph: {
    title: "Blue Barber - Best Haircuts in Town",
    description: "Visit Blue Barber for professional haircuts and grooming services.",
    url: "https://bluebarber.com",
    siteName: "Blue Barber",
    images: [{ url: "https://images.pexels.com/photos/7697487/pexels-photo-7697487.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "A joyful young boy sits in a barber chair holding a brush during a haircut indoors." }],
    type: "website",
  },
  twitter: {
    ...
    title: "Blue Barber - Best Haircuts in Town",
    description: "Visit Blue Barber for professional haircuts and grooming services.",
    images: ["https://images.pexels.com/photos/7697487/pexels-photo-7697487.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"],
  },
  robots: {
    index: true,
    follow: true,
